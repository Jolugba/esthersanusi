...
const FOCUS = [
  ...
  },
  {
    ...
    body:
      "Bringing intelligence into the products themselves — on-device and cloud ML, woven into real apps. CourtAI and Tyia were the start; the goal is AI that earns its place, never bolted on.",
    glyph:
